...
public class CreateMatchSessionHandler_Old : MenuCanvas
{
    ...
    private static CreateMatchSessionHandler_Old _instance = null;
    ...
    private void CreateMatchSession()
    {
        ...
        // MatchSessionWrapper_Old.Create(_gameMode, 
    ...
    private void CancelCreateMatch()
    {
        if(_shownRectTransform!=null)
            _shownRectTransform.gameObject.SetActive(true);
        loadingPanel.gameObject.SetActive(false);
        // MatchSessionWrapper_Old.CancelCreateMatchSession();
    }
