...
public class SocialMenu : MenuCanvas
{
    ...
    {        
        MenuManager.Instance.ChangeToMenu(AssetEnum.SentFriendRequestsMenu);
    }

    private static void OnFriendRequestClicked()
    {
        MenuManager.Instance.ChangeToMenu(AssetEnum.FriendRequestsMenu);
    }
    ...
    {
        MenuManager.Instance.ChangeToMenu(AssetEnum.FindFriendsMenu);
    }

    private static void OnFriendsButtonClicked()
    {
        MenuManager.Instance.ChangeToMenu(AssetEnum.FriendsMenu);
    }
