...
public class InviteToSessionButton : MonoBehaviour
{
    private Button button;
    private PlayingWithFriendsWrapper playingWithFriendswrapper;
...
#region UI Handling
    ...
    private void Awake()
    {
        playingWithFriendswrapper = TutorialModuleManager.Instance.GetModuleClass<PlayingWithFriendsWrapper>();
