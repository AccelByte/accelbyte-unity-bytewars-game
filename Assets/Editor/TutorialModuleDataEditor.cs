...
public class TutorialModuleDataEditor : Editor
{
    ...
    private SerializedProperty _autoGeneratedButtonModel;
    private SerializedProperty _autoGeneratedButtonModelStarter;
    ...
    private void OnEnable() 
    {
        ...
        _autoGeneratedButtonModel = serializedObject.FindProperty("autoGeneratedButtonModel");
        _autoGeneratedButtonModelStarter = serializedObject.FindProperty("autoGeneratedButtonModelStarter");
