...
public class MenuManager : MonoBehaviour
{
    ...
    {
        _currentMainMenu.gameObject.SetActive(false);
        LoadingMenuCanvas loadingMenuCanvas = (LoadingMenuCanvas)_menusDictionary[AssetEnum.LoadingMenuCanvas];
    ...
    {
        var allActiveModule = TutorialModuleManager.Instance.GetAllActiveModule();
        if (allActiveModule.TryGetValue(tutorialType, out var tutorialData))
        {
            var assetEnum = tutorialData.mainPrefab.GetAssetEnum();
